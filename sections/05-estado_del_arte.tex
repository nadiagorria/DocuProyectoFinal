...
\begin{itemize}
    ...
    \item Comunicación vía REST y WebSocket (notificaciones en tiempo real)
\end{itemize}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.9\textwidth]{Airtable.png}
