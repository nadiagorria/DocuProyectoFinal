...
\begin{figure}[htbp]
    ...
    \caption{Enumeración del dominio: valores y tipos constantes usados en el modelo.}
...
\begin{figure}[p]
    ...
    \caption{Diagrama de casos de uso -- Parte 1/3 (dividido para mejorar la visualización).}
    \label{fig:casos_uso}
\end{figure}
\begin{figure}[p]
    \centering
    \includegraphics[width=\textwidth,height=0.92\textheight,keepaspectratio]{\detokenize{casos de uso pt2.drawio.png}}
    \caption{Diagrama de casos de uso -- Parte 2/3.}
...
\begin{figure}[p]
    ...
    \caption{Diagrama de casos de uso -- Parte 3/3.}
