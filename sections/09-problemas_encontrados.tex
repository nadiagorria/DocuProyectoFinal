...
A pesar de las restricciones de tiempo, el equipo logró implementar correctamente la nueva estructura, la cual resultó ser fundamental para asegurar que el módulo cumpliera adecuadamente con los cambios solicitados por el cliente.
\cite{inia-uy}