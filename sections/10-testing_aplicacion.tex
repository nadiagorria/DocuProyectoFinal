...
El frontend, construido con Next.js y TypeScript, también incorporó pruebas automatizadas mediante Jest y React Testing Library. Estas pruebas abarcaron componentes, funciones auxiliares y ciertos elementos de la lógica de presentación. De manera similar al backend, el nivel de cobertura alcanzó el 86\%, lo que ayudó a detectar errores de visualización, manejo de datos y algunos detalles que surgieron durante la integración con la API\cite{nextjs,jest,rtl}. Las métricas detalladas se presentan en la Tabla \ref{tab:jest-metrics}.
